...
TASK_2_QUERY = """
SELECT flight_no, count(flight_no) as count FROM flights GROUP BY flight_no HAVING count(flight_no) < 50 ORDER BY count DESC LIMIT 3;
"""
#  flight_no | count
# -----------+-------
#  PG0260    |    27
...
TASK_3_QUERY = """
SELECT count(1) FROM flights AS fl JOIN airports_data AS air_a ON fl.arrival_airport = air_a.airport_code JOIN airports_data AS air_b ON fl.departure_airport = air_b.airport_code WHERE air_a.timezone = air_b.timezone;
"""
#  count
# --------
#  16824
